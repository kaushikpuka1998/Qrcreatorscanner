...
public class ContactFieldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contact_field);

        imageView = findViewById(R.id.imageView);
        floatbutton = findViewById(R.id.floatbutton);
        editText = findViewById(R.id.edittextqrgenerator);
        mStorageRef = FirebaseStorage.getInstance().getReference("GeneratedContactQR");


        b = getIntent().getExtras().getString("number");
        editText.setText(b);
        ...
        floatbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(ContactFieldActivity.this,afterreadyqrActivity.class);
                    ...
                    try {
                        ...
                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                userinfo.child("SearchType").setValue("Contacts");
                                userinfo.child("Image").setValue(downloadurl.toString() );
                                Toast.makeText(ContactFieldActivity.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ContactFieldActivity.this, "Failed"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                ...
                {
                    Toast.makeText(ContactFieldActivity.this, "TextField is Empty", Toast.LENGTH_SHORT).show();
                }
