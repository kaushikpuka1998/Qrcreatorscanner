...
public class EmailQRgenerateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_q_rgenerate);

        floatbutton = findViewById(R.id.floatbutton);
        editText = findViewById(R.id.edittextqrgenerator);
        imageView = findViewById(R.id.imageView);
        mStorageRef = FirebaseStorage.getInstance().getReference("GeneratedEmailQR");
        ...
        floatbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(EmailQRgenerateActivity.this,afterreadyqrActivity.class);
                    ...
                    try {
                        ...
                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                userinfo.child("SearchType").setValue("Email");
                                userinfo.child("Image").setValue(downloadurl.toString() );
                                Toast.makeText(EmailQRgenerateActivity.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(EmailQRgenerateActivity.this, "Failed"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                ...
                {
                    Toast.makeText(EmailQRgenerateActivity.this, "TextField is Empty", Toast.LENGTH_SHORT).show();
                }
