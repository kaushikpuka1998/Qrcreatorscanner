...
public class WebQRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_q_r);

        floatbutton = findViewById(R.id.floatbutton);
        editText = findViewById(R.id.edittextqrgenerator);
        imageView = findViewById(R.id.imageView);

        mStorageRef = FirebaseStorage.getInstance().getReference("GeneratedWebQR");
        ...
        floatbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(WebQRActivity.this,afterreadyqrActivity.class);
                    ...
                    try {
                        ...
                        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                userinfo.child("SearchType").setValue("Web");
                                userinfo.child("Image").setValue(downloadurl.toString() );
                                Toast.makeText(WebQRActivity.this, "Image Uploaded Successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(WebQRActivity.this, "Failed"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                ...
                {
                    Toast.makeText(WebQRActivity.this, "TextField is Empty", Toast.LENGTH_SHORT).show();
                }
